...
class client_py3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.network_tcp_source_0 = network.tcp_source.tcp_source(itemsize=gr.sizeof_gr_complex*1,addr=address,port=port,server=False)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.network_tcp_source_0, 0), (self.qtgui_sink_x_0, 0))
