...
def sdr_record(device, frequency, sample_rate, gain, blocks_count):
    ...
    data_format = SoapySDR.SOAPY_SDR_CS16 # if 'rtlsdr' in soapy_device or 'hackrf' in soapy_device else SoapySDR.SOAPY_SDR_CS16
...
if __name__ == "__main__":
    ...
    # Wait for the start: 01-Feb(18-May) 19:57(21:49) 20:05(21:49):
    wait_for_start(datetime.datetime(2024, 2, 1, 17, 27, 0))
